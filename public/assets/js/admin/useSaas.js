    ...
    const openSaasModal = (business = null) => {
        if (business) {
            ...
            saasForm.value = {
                ...
                allowOnlineOrders: business.allowOnlineOrders !== undefined ? business.allowOnlineOrders : false,
                ...
                hasGoldStar: business.hasGoldStar === true,
                // Métodos de pago
        ...
        try {
            ...
            if (editingBusiness.value) {
                ...
                payload = {
                    ...
                    hasGoldStar:         saasForm.value.hasGoldStar,
                    // Métodos de pago
