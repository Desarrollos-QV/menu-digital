...
app.use('/api/municipios', require('./routes/municipios')); // <-- Colonias
app.use('/api/categoriesStore', require('./routes/categoriesStore')); // <-- Categorias Globales
...
app.get(/.*/, (req, res) => {
    ...
    // 3. Rutas de Admin → Servir desde backend/panel/
